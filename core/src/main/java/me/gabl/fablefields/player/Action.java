...
public enum Action {
    ...
    MINING("mining", 10, false, 0.1f), REELING("reeling", 13, true), ROLL("roll", 10, false), RUN("run", 8, true, 0.06f),
    SWIMMING("swimming", 12, true, 0.15f), WAITING("waiting", 9, true), WALKING("walking", 8, true, 0.12f), WATERING(
