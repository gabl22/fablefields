...
public enum Action {
    ...
    MINING("mining", 10, false), REELING("reeling", 13, true), ROLL("roll", 10, false), RUN("run", 8, true, 0.075f),
    SWIMMING("swimming", 12, true), WAITING("waiting", 9, true), WALKING("walking", 8, true, 0.025f), WATERING(
