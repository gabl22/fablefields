...
public class Material {
    ...
    //primitive code
    public static final Material WATER = new Material(new Consumer<MapCell<? extends Tile>>() {
        public void accept(MapCell<? extends Tile> cell) {
            int neighbors = 0;
    ...
    public Material(Consumer<MapCell<? extends Tile>> renderCell, String name) {
