...
public class Materials {
    ...
    public static final PlantMaterial CARROT = new PlantMaterial("carrot", new float[]{1f, 1f, 1f}, PlantDropChances.CARROT);
    public static final PlantMaterial CAULIFLOWER = new PlantMaterial("cauliflower", new float[]{1f, 1f, 1f}, PlantDropChances.CAULIFLOWER);
    public static final PlantMaterial PUMPKIN = new PlantMaterial("pumpkin", new float[]{1f, 1f, 1f}, PlantDropChances.PUMPKIN);
    public static final PlantMaterial SUNFLOWER = new PlantMaterial("sunflower", new float[]{1f, 1f, 1f}, PlantDropChances.SUNFLOWER);
    public static final PlantMaterial RADISH = new PlantMaterial("radish", new float[]{1f, 1f, 1f}, PlantDropChances.RADISH);
    public static final PlantMaterial PARSNIP = new PlantMaterial("parsnip", new float[]{1f, 1f, 1f}, PlantDropChances.PARSNIP);
    public static final PlantMaterial POTATO = new PlantMaterial("potato", new float[]{1f, 1f, 1f}, PlantDropChances.POTATO);
    public static final PlantMaterial CABBAGE = new PlantMaterial("cabbage", new float[]{1f, 1f, 1f}, PlantDropChances.CABBAGE);
    public static final PlantMaterial BEETROOT = new PlantMaterial("beetroot", new float[]{1f, 1f, 1f}, PlantDropChances.BEETROOT);
    public static final PlantMaterial WHEAT = new PlantMaterial("wheat", new float[]{1f, 1f, 1f}, PlantDropChances.WHEAT);
    public static final PlantMaterial LETTUCE = new PlantMaterial("lettuce", new float[]{1f, 1f, 1f}, PlantDropChances.LETTUCE);
